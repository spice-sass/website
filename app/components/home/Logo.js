let Logo = React.createClass({
	...
	render () {
		return (
			<div className={'centre-y text-centre ' + this.state.seqClasses}>
				<div id="main-logo">
					...
					<g className="logo-wrapper">
						...
						<g className="sp">
							<path className="text s" d="M-159.5,310.5v6.2c0,5.3,6.7,8.5,14.5,8.5c8.4,0,14.3-3.6,14.3-10.2c0-8.4-9.4-11-18.9-14.8
							...
							<path className="text p" d="M-73.7,325.8h9.9v-59.7h-9.9v-11.5h39.5c4.9,0,9.9,0.3,13.9,2.1c8.9,3.7,14.8,12.9,14.8,24.4
						...
						<g className="ce">
							<path className="text c" d="M154.7,253.2c10,0,32.2,3.5,32.2,16.5v11.2H173v-6.4c0-6.2-10.9-8.3-17.7-8.3c-15.9,0-27.5,11.2-27.5,28.6
							...
							<path className="text e" d="M229.7,325.8h9.9v-59.7h-9.9v-11.5H291v21.3h-13v-9.1h-23.1v22.7H282v12.2h-27.2v23.2h24.9v-9.3h13v21.5h-63
								L229.7,325.8L229.7,325.8z"/>
						</g>
					</g>
				</svg>
				</div>
				<h2 id="strap" className="roboto-slab">{'The sass library for tasty web interfaces'}</h2>
				<a href="#installation" className="button flat-secondary block-icon-download">Installation</a>
				<a href="/documentation" className="button flat-primary block-icon-open-book">View Docs</a>
				<p className="version-number">{'Version '+versionNumber}</p>
			</div>
		)
	}
});
